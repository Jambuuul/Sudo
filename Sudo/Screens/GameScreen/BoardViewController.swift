...
final class BoardViewController: UIViewController {
	...
	private enum Const {
		...
		static let titleToTimeSpacing: CGFloat = 6
		static let timeToStatusSpacing: CGFloat = 6
		static let statusToBoardSpacing: CGFloat = 5
		static let boardToControlsSpacing: CGFloat = 5
		static let controlsToSaveSpacing: CGFloat = 12
		static let saveToClearSpacing: CGFloat = 8
	...
	private func configureTimeLabel() {
		...
		timeLabel.pinRight(to: view, Const.horizontalInset)
	}
	...
	private func configureStatusLabel() {
		...
		statusLabel.pinTop(to: timeLabel.bottomAnchor, Const.timeToStatusSpacing)
	...
	private func configureSaveButton() {
		...
		saveButton.backgroundColor = .systemIndigo.withAlphaComponent(0.85)
		saveButton.layer.cornerRadius = Const.saveButtonCornerRadius
		saveButton.setTitle(Const.saveButtonTitle, for: .normal)
		saveButton.titleLabel?.font = .systemFont(ofSize: Const.saveButtonFontSize, weight: .semibold)
		saveButton.setTitleColor(.white, for: .normal)
		saveButton.addTarget(self, action: #selector(saveButtonPressed), for: .touchUpInside)
		
		saveButton.pinTop(to: controlsStackView.bottomAnchor, Const.controlsToSaveSpacing)
		saveButton.pinLeft(to: view, Const.horizontalInset)
		saveButton.pinRight(to: view, Const.horizontalInset)
		saveButton.setHeight(Const.saveButtonHeight)
	}
	...
	private func configureClearButton() {
		...
		clearButton.pinTop(to: saveButton.bottomAnchor, Const.saveToClearSpacing)
